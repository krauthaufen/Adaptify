//bf50d994-2e1c-8f6f-63c6-873c0488f015
//f3c35136-6069-1c23-b716-27e1f28cb45a
...
module MyModelLenses = 
    type MyModel with
        ...
        static member x_ = ((fun (self : MyModel) -> self.x), (fun (value : Microsoft.FSharp.Core.int) (self : MyModel) -> { self with x = value }))
