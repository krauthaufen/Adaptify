...
type AdaptiveObject<'a, '_prima, '_aa>(value : Object<'a>, _primainit : 'a -> System.Object, _primaupdate : System.Object -> 'a -> System.Object, _primaview : System.Object -> '_prima, _ainit : 'a -> System.Object, _aupdate : System.Object -> 'a -> System.Object, _aview : System.Object -> '_aa) =
    ...
    let _a_ =
        ...
        let inline __arg11 (o : System.Object) (v : Microsoft.FSharp.Core.string) =
            ...
            o
        Adaptify.FSharp.Core.AdaptiveResult<LibraryModel.Object<'a>, LibraryModel.AdaptiveObject<'a, '_prima, '_aa>, LibraryModel.AdaptiveObject<'a, '_prima, '_aa>, Microsoft.FSharp.Core.string, Microsoft.FSharp.Core.string, FSharp.Data.Adaptive.aval<Microsoft.FSharp.Core.string>>(value.a, __arg1, (fun (o : System.Object) (v : Object<'a>) -> (unbox<AdaptiveObject<'a, '_prima, '_aa>> o).Update(v) :> System.Object), (fun (o : System.Object) -> unbox<AdaptiveObject<'a, '_prima, '_aa>> o), __arg4, __arg5, (fun (o : System.Object) -> unbox<AdaptiveObject<'a, '_prima, '_aa>> o), (fun (v : Microsoft.FSharp.Core.string) -> v :> System.Object), (fun (o : System.Object) (v : Microsoft.FSharp.Core.string) -> v :> System.Object), (fun (o : System.Object) -> unbox<Microsoft.FSharp.Core.string> o), (fun (v : Microsoft.FSharp.Core.string) -> FSharp.Data.Adaptive.cval(v) :> System.Object), __arg11, (fun (o : System.Object) -> unbox<FSharp.Data.Adaptive.cval<Microsoft.FSharp.Core.string>> o :> FSharp.Data.Adaptive.aval<Microsoft.FSharp.Core.string>))
